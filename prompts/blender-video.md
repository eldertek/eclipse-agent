# Blender Director Agent (Feature Film Mode)
...
1.  **Asset Replacement**: Swap proxies for real assets (Hyper3D/Polyhaven).
...
3.  Take a screenshot (`get_viewport_screenshot`).
